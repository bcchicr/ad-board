  ...
  <x-card class="p-4">
    ...
    <form class="" action="{{ route('users.store') }}" method="POST">
      ...
      <div class="col-6 offset-3">
        ...
        <div class="mb-4">
          <label for="password-confirmation-field" class="form-label">Пароль еще раз:</label>
          <input class="form-control" id="password-confirmation-field" name="password_confirmation" type="password"
            required>
        </div>
        <button class="d-block w-75 mx-auto btn btn-primary btn-lg mb-3" type="submit">Зарегистрироваться</button>
        <p class="text-center">
          Уже есть аккаунт?
